-- =============================================================================
-- venextrading — SETUP COMPLETO (ejecutar UNA vez en Supabase SQL Editor)
-- Proyecto: iumphhulhzhxleomgfzx
-- Dashboard: https://supabase.com/dashboard/project/iumphhulhzhxleomgfzx/sql/new
-- =============================================================================
...
-- AÃ±adir company y phone a profiles para datos del proveedor
...
-- Ejecutar en Supabase SQL Editor despuÃ©s de migraciones anteriores
...
insert into public.roles (id, name, description) values
  ...
  ('proveedor', 'Proveedor', 'Vendedor legacy â€” gestiÃ³n de productos propios')
on conflict (id) do nothing;

-- =============================================================================
-- PROFILES â€” ampliar roles
-- =============================================================================
...
-- =============================================================================
-- PRODUCTS â€” columnas extendidas
-- =============================================================================
...
-- Products: actualizar polÃ­ticas
...
insert into public.categories (name, slug, description, sort_order) values
  ('ElectrÃ³nica', 'electronica', 'Dispositivos y componentes electrÃ³nicos', 1),
...
select
  ...
  '["Transferencia","Pago mÃ³vil","Zelle"]'::jsonb,
  '["EnvÃ­o nacional","Retiro en almacÃ©n"]'::jsonb
where not exists (select 1 from public.store_settings limit 1);
-- Corrige creaciÃ³n de perfil al registrar usuario (evita fallos silenciosos en signUp)
